...
//----------------------------------------------------------------------------------------------------
// SimulationApp - Application class contains all necessary components in order to run app correctly.
//----------------------------------------------------------------------------------------------------
...
public:
	...
	inline IntVector2 GetCurrentWindowSize() { return m_SimulationOptions.GetWindowsOptions().m_ScreenSize; }
	inline SimulationOptions& GetSimulationOptions() { return m_SimulationOptions;  }
...
protected:
    SimulationOptions m_SimulationOptions;			// User specific startup simulation options
...
extern SimulationApp* g_pApp;					// Global pointer, which is visible for whole program.
